...
make -C $(pwd) O=out -j8 ARCH=arm64 CROSS_COMPILE=~/toolchains/aarch64-linux-android-4.9/bin/aarch64-linux-android- KCFLAGS=-mno-android crownqlte_usa_single_defconfig
